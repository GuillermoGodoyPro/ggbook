    ...
    <section className='section mb-80' id='about' ref={ref}>
      <div className="container mx-auto bg-about bg-no-repeat mix-blend-lighten bg-top">
        <motion.div 
          ...
          className='flex gap-y-10 lg:gap-x-10 lg:gap-y-0 h-[100%] lg:flex-row lg:items-center'>
          {/* img */}
          ...
          <div className='flex-1'>
            ...
            {/* stats */}
            <div className='xs:flex-col justify-center gap-x-6 lg:gap-x-10 mb-12 hidden' >
              <div>
